            ...
            <dl class="mt-3 w-full">
                ...
                <dd class="flex">
                    <div class="flex justify-between">
                        <a href="mailto:mateus@junges.dev" class="pr-2 text-black font-super-bold text-3xl cursor-pointer" target="_blank">{{ svg('mail') }}</a>
                        <a href="https://github.com/mateusjunges" class="pr-2 text-black font-super-bold text-3xl cursor-pointer" target="_blank">{{ svg('github-1') }}</a>
                        <a href="https://twitter.com/mateusjungess/" class="pr-2 text-black font-super-bold text-3xl cursor-pointer" target="_blank">{{ svg('twitter') }}</a>
                        <a href="https://www.linkedin.com/in/mateusjunges/" class="text-black font-super-bold text-3xl cursor-pointer" target="_blank">{{ svg('linkedin') }}</a>
                    </div>
                </dd>
            </dl>
            <div class="mt-10 font-inter text-">
                <div class="experience flex flex-col bg-gray-light bg-opacity-50 rounded py-4 px-2 hover:bg-gray-60 my-4">
