...
<li class="flex px-2 mb-4 w-full leading-5 text-left break-words lg:w-1/2 md:w-1/2 text-slate-300">
    <div
        class="flex p-4 w-full leading-5 text-left break-words rounded-md bg-gray-800 hover:bg-blue-800 text-slate-300">
        <div
            ...
            <div class="leading-5 text-left items-center text-slate-300">
                <a href="{{ action([\App\Modules\Documentation\Http\Controllers\DocsController::class, 'repository'], $repository->slug) }}"
                   class="flex items-center">
                    ...
                    <span
                        class="font-semibold leading-5 text-left text-white break-words cursor-pointer"
            ...
            <!-- Slogan -->
            <p class="flex-grow flex-shrink-0 mt-2 mb-0 text-xs leading-4 text-left break-words basis-auto text-white">
            ...
            <div
                class="mt-2 text-xs text-white flex flex-row gap-2 justify-start items-center">
                <p class="text-left">Available Versions:</p>
                <div>
                    @foreach($repository->getSortedAliases() as $alias)
                        <span>
                            <a class="inline-flex items-center underline justify-center px-2 hover:font-super-bold {{ $loop->first ? 'text-white hover:text-black font-bold' : 'text-white hover:font-super-bold'}}"
            ...
            <div
                ...
                <div class="flex">
                    <a href="{{ $repository->getStargazersUrl() }}"
                       class="inline-block text-xs leading-4 text-left text-white break-words bg-transparent cursor-pointer flex items-center"
                    ...
                    @if($githubRepositories->where('name', $repository->slug)->first()->forks !== null || app()->environment('local'))
                        <a
                            ...
                            class="flex ml-4 text-xs leading-4 text-left text-white break-words bg-transparent cursor-pointer items-center">
                ...
                <div class="text-right flex text-white">
