...
<li class="flex mb-4 w-full leading-5 text-left break-words text-slate-300">
    <div
        class="flex py-4 w-full leading-5 text-left break-words rounded-md text-slate-300">
        <div
            class="flex flex-col w-full leading-5 text-left rounded-md text-slate-300">
            <div class="leading-5 text-left items-center text-slate-300">
                <a href="{{ action([\App\Modules\Docs\Http\Controllers\DocsController::class, 'repository'], $repository->slug) }}"
                   class="flex items-center">
                    <svg aria-hidden="true" height="16" viewBox="0 0 16 16" version="1.1"
                         width="16" class="text-black mr-1 hidden md:block"
                         fill="currentColor">
                        <path fill-rule="evenodd"
                              d="M2 2.5A2.5 2.5 0 014.5 0h8.75a.75.75 0 01.75.75v12.5a.75.75 0 01-.75.75h-2.5a.75.75 0 110-1.5h1.75v-2h-8a1 1 0 00-.714 1.7.75.75 0 01-1.072 1.05A2.495 2.495 0 012 11.5v-9zm10.5-1V9h-8c-.356 0-.694.074-1 .208V2.5a1 1 0 011-1h8zM5 12.25v3.25a.25.25 0 00.4.2l1.45-1.087a.25.25 0 01.3 0L8.6 15.7a.25.25 0 00.4-.2v-3.25a.25.25 0 00-.25-.25h-3.5a.25.25 0 00-.25.25z"></path>
                    </svg>
                    <span
                        class="font-semibold leading-5 text-left text-black break-words cursor-pointer hover:underline"
            ...
            <div
                class="mt-2 text-xs text-black flex flex-row gap-2 justify-start items-center">
            ...
            <div
                ...
                <div class="flex">
                    <a href="{{ $repository->getStargazersUrl() }}"
                       class="inline-block text-xs leading-4 text-left text-black break-words bg-transparent cursor-pointer flex items-center"
                    ...
                    @if($githubRepositories->where('name', $repository->slug)->first()->forks !== null || app()->environment('local'))
                        <a
                            ...
                            class="flex ml-4 text-xs leading-4 text-left text-black break-words bg-transparent cursor-pointer items-center">
                ...
                <div class="text-right flex text-black">
