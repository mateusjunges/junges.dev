...
<li class="flex px-2 mb-4 w-full leading-5 text-left, break-words lg:w-1/2 md:w-1/2 text-slate-300">
    <div
        ...
        <div class="flex flex-col p-4 w-full leading-5 text-left rounded-md text-slate-300">
            ...
            <div class="mt-2 text-xs text-gray-700 grid grid-flow-col gap-2 justify-start items-center">
                Available Versions:
