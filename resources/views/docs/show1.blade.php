...
<x-page
    ...
    <div class="flex flex-col">
        ...
        <div class="font-inter w-full">
            <div class="wrap md-grid pb-24 gap-12 md:grid-cols-10 flex flex-col md:flex-row items-stretch w-full">
                <div class="md:mr-8">
                    @include('docs.partials.navigation')
                </div>
                <article class="md:col-span-7 lg:col-span-6">
                    @if(count($repository->aliases) > 1)
                        <div class="mb-12 p-4 flex text-sm bg-opacity-50 rounded-sm md:shadow-light markup-code bg-blue-dark">
